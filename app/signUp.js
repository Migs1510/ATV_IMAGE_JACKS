...
export default function SignUp() {
    ...
    // Refs para os dados de input
    const emailRef = useRef("");
    const passwordRef = useRef("");
    const usernameRef = useRef("");
    const profileRef = useRef(""); // Mantemos o ref para enviar no cadastro

    // Estado para a URI da imagem selecionada (para re-renderizar)
    ...
    const pickImage = async () => {
        ...
        if (!result.canceled) {
            ...
            setProfileImage(imageUri);       // Atualiza estado para mostrar a imagem
            profileRef.current = imageUri;   // Atualiza ref para envio no cadastro
                ...
                <View className="gap-10">
                    ...
                    <View className="gap-4">
                        ...
                        >
                            ...
                            <Text style={{ fontSize: hp(2), color: 'gray' }} className="font-semibold">
                                Selecionar imagem do perfil
                            </Text>
                        </TouchableOpacity>

                        {/* Mostrar a miniatura da imagem selecionada */}
                        {profileImage && (
